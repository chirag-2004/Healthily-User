            ...
            <div className="keen-slider__slide transition-opacity duration-500">
              <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                ...
                <p className="mt-4 text-gray-700">
                  Thanks  for making us your partner. With this partnership
                  We were not only able to build trust within our customers but
                  also was able to provide them online consultation. Your
                  partnership has helped us in increasing our business
                </p>
              </blockquote>
            </div>

            <div className="hidden md:block keen-slider__slide transition-opacity duration-500">
              <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                <div className="flex items-center gap-4">
                  <img
                    alt=""
                ...
                <p className="mt-4 text-gray-700">
                  I have been practising physiotherapy from last 12 years, This Platform
                  has helped me in bringing efficiency to my overall practice.
